...
class ProductResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'brand_id' => $this->whenLoaded('carModel', fn() => $this->carModel->brand->id),
            'model_id' => $this->whenLoaded('carModel', fn() => $this->carModel->id),
            'category_id' => $this->whenLoaded('productCategory', fn() => $this->productCategory->id),
        ];
    }
}
