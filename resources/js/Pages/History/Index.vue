        ...
        <div class="bg-white">
                            ...
                            <table class="mt-4 w-full text-gray-500 sm:mt-6">
                                ...
                                <tr v-for="item in order.order_items">
                                    ...
                                    <td class="py-6 font-medium text-right whitespace-nowrap">
                                        <a href="#" class="text-indigo-600">View<span class="hidden lg:inline"> Product</span></a>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
            ...
            <div v-else class="w-full  py-16 px-4 sm:px-6 lg:pb-24 lg:px-8">
                <div class="flex w-full justify-center">
                    <h1 class="text-2xl text-center font-extrabold tracking-tight text-gray-900 sm:text-3xl">You haven't made any orders yet</h1>
                    </div>
