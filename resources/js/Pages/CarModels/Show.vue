<template>
    ...
    <div class="max-w-lg mx-auto">
        ...
        <div class="max-w-xl rounded overflow-hidden shadow-lg">
            ...
            <div class="px-6 py-4">
                <div class="font-bold text-xl mb-2">{{ carModel.data.name }}</div>
                <p v-if="carModel.data.description" class="text-gray-700 text-base">
            ...
            <div class="flex gap-3 px-6 py-4">
                ...
                <DeleteModal v-if="can.delete" :url="$page.url"/>
            </div>
        </div>
    </div>
</template>
